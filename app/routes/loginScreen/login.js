...
export default class LoginScreen extends Component {
  ...
  _fbAuth() {
    LoginManager.logInWithReadPermissions(['email', 'user_friends', 'public_profile', 'user_photos', 'user_birthday']).then((result) => {
            ...
            firebase.auth().signInAndRetrieveDataWithCredential(credential).then((result) => {
              ...
              const infoRequest = new GraphRequest(
                '/me',
                {
                  parameters: {
                    fields: {
                      string: 'email, name, first_name, middle_name, last_name, picture.type(large), albums{name, photos{name, picture}}, gender, birthday, age_range'
                    },
                    access_token: {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.loginSection}>
          ...
          />
          <TouchableHighlight onPress={this._fbAuth.bind(this)} disabled={this.state.dsiabled}>
            <Image
